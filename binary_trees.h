 ...
 *
 * Description: This structure represents a single node in a binary tree.
 * It stores an integer value and pointers to its parent and children, 
 * allowing traversal in all directions (parent, left, right).
 */
